...
//Remove agent
// Route::post('/deleteAgent', 'AgentController@destroy')->name('agent.remove');
Route::post('/deleteAgent/{id}', 'AgentController@destroy')->name('agent.remove');
//Edit agent
...
//Remove Project
Route::post('/deleteProject', 'ProjectController@destroy')->name('project.remove');
//Edit Project
...
Route::get('/getAgents', function () {
    $agents = App\Agent::with('projects:project_id,project_name')->get();
