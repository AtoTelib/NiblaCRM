...
Vue.component('project-post-component', require('./components/post/ProjectPostComponent.vue').default);
Vue.component('contract-table-component', require('./components/tables/ContractTableComponent.vue').default);
Vue.component('project-table-component', require('./components/tables/ProjectTableComponent.vue').default);
...
Vue.component('project-remove-modal-component', require('./components/modal/Projects/ProjectRemoveModalComponent.vue').default);
Vue.component('contract-edit-modal-component', require('./components/modal/Contracts/ContractEditModalComponent.vue').default);
Vue.component('project-edit-modal-component', require('./components/modal/Projects/ProjectEditModalComponent.vue').default);
